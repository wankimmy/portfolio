# BosskuAI Rules Distill Command

Use this command to extract repeated principles from local skills and references, then propose stronger shared rules.

## Intent

- find cross-cutting guidance worth promoting
- reduce fragmentation across skills and references
- draft safe rule improvements without auto-applying them
